<?php
/**
 * Template buddy profile settings general page
 *
...
<form action="<?php echo bp_displayed_user_domain() . bp_get_settings_slug() . '/general'; ?>" method="post" class="standard-form" id="settings-form">
	...
	<?php if ( !is_super_admin() ) : ?>
		...
		<label for="pwd"><?php _e( 'Current Password <span>(required to update email or change current password)</span>', 'zola' ); ?></label>
		<input type="password" name="pwd" id="pwd" size="16" value="" class="settings-input small" <?php bp_form_field_attributes( 'password' ); ?>/> &nbsp;<a href="<?php echo wp_lostpassword_url(); ?>" title="<?php esc_attr_e( 'Password Lost and Found', 'zola' ); ?>"><?php _e( 'Lost your password?', 'zola' ); ?></a>

	<?php endif; ?>

	<label for="email"><?php _e( 'Account Email', 'zola' ); ?></label>
	...
	<label for="pass1"><?php _e( 'Change Password <span>(leave blank for no change)</span>', 'zola' ); ?></label>
	...
	<label for="pass2" class="bp-screen-reader-text"><?php _e( 'Repeat New Password', 'zola' ); ?></label>
	...
	<div class="buddy-settings-general-submit">
